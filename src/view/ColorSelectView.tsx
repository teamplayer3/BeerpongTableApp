...
export default function ColorSelectView(props: {
    ...
    const [viewHeight, setViewHeight] = useState<number>(Dimensions.get('screen').height / 2)
        ...
        <Shadow distance={15} offset={[0, 3]}>
            <View style={{
                ...
                <View style={{
                    ...
                    <ColorPicker style={{ flexGrow: 1 }} startColor={colorSelectState.pickerColor} onClolorChange={(color) => potHandler.changeColorOfSelected(color)} height={50} />
                    <IconButton color={colorSelectState.isSelecting ? '#FF0000' : '#000000'} icon="eyedropper" onPress={toggleColorSelecting} />
                </View>
