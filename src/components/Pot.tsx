...
export default function PotComponent(props: {
    ...
    return (
        <AnimatedTouchable style={{
            ...
            {props.backdropColor && <BackdropColor color={props.backdropColor} size={backdropSize} scale={scale} />}
            <Animated.View style={{
                position: 'absolute',
...
const BackdropColor = (props: {
    ...
    return (
        ...
        >
            ...
            <AnimatedCircle cx={svgCircleAnimation} cy={svgCircleAnimation} r={svgCircleAnimation} fill="url('#myGradient')" />
        </Svg >
    )
}